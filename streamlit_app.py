...
st.set_page_config(page_title="2022-2023 sem-1 Case 3: Dashboard", page_icon="👩‍🎓", layout = "wide", initial_sidebar_state="expanded")
...
pages = st.sidebar.radio('paginas', options=['Home',"Elektrische auto's", 'Chargemap', 'Laadpaaldata', 'Voorspelling'], label_visibility='hidden')
